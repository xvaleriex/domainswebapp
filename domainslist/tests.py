...
class DomainsListTest(TestCase):
    ...
    def create_domain(self, fqdn="testfqdn", datetime_creation=datetime.fromisoformat("2019-12-10T12:10:23+00:00"),
                      datetime_expiration=datetime.fromisoformat("2020-07-05T12:12:00+00:00"), datetime_deletion=None):
        if datetime_deletion is None:
            return Domain.objects.create(fqdn=str(fqdn), datetime_creation=str(datetime_creation),
    ...
    def create_domain_flag(self, domain, type="EXPIRED",
        ...
        self.domain = domain
        return DomainFlag.objects.create(domain=domain, type=type, datetime_from=datetime_from,
    ...
    def test_domainslist_index_view_statuscode(self):
        # Test status code
        d1 = self.create_domain()
        d2 = self.create_domain(fqdn="testfqdn2", datetime_creation=datetime.fromisoformat("2019-11-10T12:10:23+00:00"),
    ...
    def test_domainslist_index_view_not_active(self):
        ...
        d3 = self.create_domain(fqdn="testfqdn3", datetime_creation=datetime.fromisoformat("2019-11-10T12:10:23+00:00"),
                                datetime_expiration=datetime.fromisoformat("2020-04-05T12:12:00+00:00"),
                                datetime_deletion=datetime.fromisoformat("2020-01-01T12:12:00+00:00"))
        d4 = self.create_domain(fqdn="testfqdn4", datetime_creation=datetime.fromisoformat("2019-11-10T12:10:23+00:00"),
                                datetime_expiration=datetime.fromisoformat("2020-04-05T12:12:00+00:00"),
                                datetime_deletion=datetime.fromisoformat("2020-01-01T12:12:00+00:00"))
        resp = self.client.get("/domainslist/")
        domains_count = len(resp.context['domains'])
